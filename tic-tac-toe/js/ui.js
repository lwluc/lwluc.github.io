...
const svg_x = '<svg class="crosses" aria-label="X" role="img" viewBox="0 0 128 128" ><path d="M16,16L112,112" style="stroke: rgb(108, 90, 73); "></path><path d="M112,16L16,112" style="stroke: rgb(108, 90, 73); "></path></svg>';
const svg_o = '<svg class="noughts" aria-label="O" role="img" viewBox="0 0 128 128" ><path d="M64,16A48,48 0 1,0 64,112A48,48 0 1,0 64,16" style="stroke: rgb(155, 197, 157);"></path></svg>';
const svg_xo = '<svg class="crosses" aria-label="X" role="img" viewBox="0 0 128 128" style="width: 96px; height: 96px;"><path d="M16,16L112,112" style="stroke: rgb(108, 90, 73);"></path><path d="M112,16L16,112" style="stroke: rgb(108, 90, 73);"></path></svg>\
...
const svg_horizontal = '<svg class="crosses" aria-label="H" role="img" viewBox="0 0 128 128" ><path d="M0,64L128,64" style="stroke: rgb(0, 0, 0); stroke-width: 2.5px; "></path></svg>';
const svg_vertical = '<svg class="crosses" aria-label="V" role="img" viewBox="0 0 128 128" ><path d="M64,0L64,128" style="stroke: rgb(0, 0, 0); stroke-width: 2.5px; "></path></svg>';
const svg_diag = '<svg class="crosses" aria-label="D1" role="img" viewBox="0 0 128 128" ><path d="M16,16L128,128" style="stroke: rgb(0, 0, 0); stroke-width: 4px;"></path></svg>';
...
UI.drawBoard = () => {
	...
	document.getElementById('messageboard').innerHTML = "<span><br>Play against me to view my page!</span>";
}
